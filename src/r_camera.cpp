...
Camera::Camera(std::shared_ptr<GraphicsDevmem> devmem, float fov, float aspect_ratio, float near, float far, const glm::vec3& position, const glm::vec3& target, const glm::vec3& up): fov(fov),
